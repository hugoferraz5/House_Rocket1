...
def hipoteses(data):
    ...
    fig6 = px.bar(h8, x='contrucao', y='price', color='contrucao',
                  labels={'price': 'Preço', 'contrucao': 'Tempo de Imóveis não renovados'},
                  template='simple_white')
...
def questoes_negocio(data):
    ...
    fig11 = px.bar(df5, x='season', y='sale', color='season',
                   labels={'season': 'Estação do Ano', 'sale': 'Preço de Venda'},
                   template='simple_white')
